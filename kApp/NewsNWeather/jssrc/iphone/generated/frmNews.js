function addWidgetsfrmNews() {
    ...
    flexMenuContainer.add(SegNewsOptions);
    ...
    flexNewsContainer.add(segmentNews);
    ...
    frmNews.add(flexMenuContainer, flexNewsContainer, lblFrmNewsTitle, btnMenu, Button09883d4a5c77342);
};
